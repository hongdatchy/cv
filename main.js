$(document).ready(function(){
	...
	for(let i = 0; i<5;i++){
		$('.content-natigation li:nth-child('+(i+1)+')').on('click', function(event) {
			...
			$('html').animate({
				scrollTop:my_section_arr[i].offset().top+5},600,"easeInOutCubic");
...
function active_section() {
	...
	$('.content-natigation li:nth-child('+(x)+')').addClass('active');
	$('.content-natigation li:nth-child('+(x-1)+')').removeClass('active');
	$('.content-natigation li:nth-child('+(x+1)+')').removeClass('active');
// 
	$('.content-natigation li:nth-child('+(x)+') i').addClass('active');
	$('.content-natigation li:nth-child('+(x-1)+') i').removeClass('active');
	$('.content-natigation li:nth-child('+(x+1)+') i').removeClass('active');
// 
	$('.content-natigation li:nth-child('+(x)+') span').addClass('active');
	$('.content-natigation li:nth-child('+(x-1)+') span').removeClass('active');
	$('.content-natigation li:nth-child('+(x+1)+') span').removeClass('active');
}